...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean zoomer
        {
            get
            {
                return SteamVR_Actions.default_zoomer;
            }
        }
        
        public virtual SteamVR_Action_Boolean boomer
        {
            get
            {
                return SteamVR_Actions.default_boomer;
            }
        }
        
        public virtual SteamVR_Action_Boolean switchA
        {
            get
            {
                return SteamVR_Actions.default_switchA;
            }
        }
        
        public virtual SteamVR_Action_Boolean switchB
        {
            get
            {
                return SteamVR_Actions.default_switchB;
            }
        }
        
        public virtual SteamVR_Action_Boolean ressetter
        {
            get
            {
                return SteamVR_Actions.default_ressetter;
            }
        }
